...
public class Dashboard extends Base {
    ...
    public Dashboard() {
        ...
        tblServiceDelivered.setModel(dash.serviceDeliverTable());
        tblServiceNew.setModel(dash.serviceTable());
    }
    ...
    private void initComponents() {
        ...
        tblServiceDelivered = new JTable();
        ...
        btnTechnical.addActionListener(e -> btnAddServiceClick(e));
        ...
        //======== scrollPane1 ========
        {
            scrollPane1.setViewportView(tblServiceNew);
        }

        //======== scrollPane2 ========
        {
            scrollPane2.setViewportView(tblServiceDelivered);
        }
    ...
    private JTable tblServiceDelivered;
